            ...
            <form name="frmAdd" id="frmAdd" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input class="validate[required] form-control" type="text" name="idInput" id="idInput" value="<?php echo $id ?>" readonly>
                            <input class="form-control" type="hidden" name="oldId" id="oldId" value="<?php echo $id ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="nombre-casilla-1"><span>*</span>Nombre:</label>
                            <input class="validate[required] form-control" type="text" name="nombreInput" id="nombreInput" value="<?php echo $nombre ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="nombre-casilla-1"><span>*</span>Descripcion:</label>
                            <input class="validate[required] form-control" type="text" name="descInput" id="descInput" value="<?php echo $desc ?>">
                        </div>
                    </div>
                    <br>
                </div>
                <div class="modal-footer">
                    <div class="col-md-12 text-right" id="opcGuardarHech">
                        <button type="button" class="btn btn-primary btn-block" onClick="validarFrm(1)">
